...
__kernel void vitechain_work (__global ulong * attempt, __global ulong * result_a, __global uchar * item_a, const ulong threshold)
{
 ...
 thresholdarry[0] = (uchar)((threshold >> 24) & 0xFF) ;
 thresholdarry[1] = (uchar)((threshold >> 16) & 0xFF) ;
 thresholdarry[2] = (uchar)((threshold >> 8) & 0XFF);
 thresholdarry[3] = (uchar)((threshold & 0XFF));
